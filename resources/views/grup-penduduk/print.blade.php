...
<head>
    ...
    <title>Daftar Anggota Grup Pemerintahan Desa {{ $desa->nama }}</title>
...
<body onload="window.print()" oncontextmenu="return false;">
    ...
    <div class="text-center mb-3">
        <h5 class="font-weight-bold text-uppercase">Daftar Anggota {{ $grup->nama }}</h5>
    </div>
    <table style="padding: 0px; font-size: 0.7rem">
        ...
        <tr>
            <td width="100px">Sasaran Anggota</td>
            <td width="1px">:</td>
