...
@section('title', 'Tambah Anggota Grup')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Anggota Grup</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td style="padding:0.5rem;" width="1px">:</td>
                                <td style="padding:0.5rem;">
                                    <input type="text"  class="form-control @error('sk') is-invalid @enderror" name="sk" placeholder="Masukkan SK Pengangkatan" value="{{ old('sk') }}">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding:0.5rem;" width="1px">:</td>
                                <td style="padding:0.5rem;">
                                    <input type="date" class="form-control @error('tgl_pelantikan') is-invalid @enderror" name="tgl_pelantikan" placeholder="Masukkan Tanggal Pelantikan" value="{{ old('tgl_pelantikan') }}">
                                </td>
                            </tr>
                            <tr>
