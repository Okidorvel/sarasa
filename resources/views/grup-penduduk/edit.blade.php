...
@section('title', 'Edit Anggota Grup')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Edit Anggota Grup</h2>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('grup-penduduk.update', $grup_penduduk) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header text-white bg-info font-weight-bold"><i class="fas fa-user"></i> Konfirmasi Anggota</div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm">
                            ...
                            <tr>
                                <td style="padding:0.5rem; white-space: normal !important; word-wrap: break-word;" width="200px">Jabatan</td>
                                <td style="padding:0.5rem;" width="1px">:</td>
                                <td style="padding:0.5rem;">
                                    <input type="text"  class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" placeholder="Masukkan Jabatan" value="{{ old('jabatan',$grup_penduduk->jabatan) }}">
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:0.5rem; white-space: normal !important; word-wrap: break-word;" width="200px">SK Pengangkatan</td>
                                <td style="padding:0.5rem;" width="1px">:</td>
                                <td style="padding:0.5rem;">
                                    <input type="text"  class="form-control @error('sk') is-invalid @enderror" name="sk" placeholder="Masukkan SK Pengangkatan" value="{{ old('sk',$grup_penduduk->sk) }}">
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:0.5rem; white-space: normal !important; word-wrap: break-word;" width="200px">Tanggal Pelantikan</td>
                                <td style="padding:0.5rem;" width="1px">:</td>
                                <td style="padding:0.5rem;">
                                    <input type="date" class="form-control @error('tgl_pelantikan') is-invalid @enderror" name="tgl_pelantikan" placeholder="Masukkan Tanggal Pelantikan" value="{{ old('sk',$grup_penduduk->tgl_pelantikan) }}">
                                </td>
                            </tr>
                            <tr>
