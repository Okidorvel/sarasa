...
@section('title', 'SARASA - Desa '. App\Desa::find(1)->nama_desa . ' - Produk Hukum')
    ...
    <div class="header-body text-center mt-5 mb-3">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6 border-bottom">
                ...
                <p class="">Masyarakat dapat dengan mudah mengetahui informasi mengenai Produk Hukum Desa {{ $desa->nama_desa }}.</p>
            </div>
        </div>
    </div>
    <div class="row justify-content-center">
