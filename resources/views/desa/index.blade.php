            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="telepon" type="text" id="telepon" class="form-control form-control-alternative @error('telepon') is-invalid @enderror" placeholder="Masukkan Telepon" value="{{ old('telepon',$desa->telepon) }}">
                            @error('telepon')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input name="fax" type="text" id="fax" class="form-control form-control-alternative @error('fax') is-invalid @enderror" placeholder="Masukkan Fax" value="{{ old('fax',$desa->fax) }}">
                            @error('fax')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
