                ...
                <form autocomplete="off" action="{{ route("surat.store") }}" method="post">
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="tampilkan_perihal">Perihal</label> <a href="{{ url('img/bantuan-perihalaaaa.png') }}" data-fancybox data-caption="Akan menampilkan surat seperti ini"><i class="fas fa-question-circle text-blue" title="Bantuan" data-toggle="tooltip"></i></a>
                        </div>
                        <div class="custom-control custom-checkbox">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="tampilkan_tembusan" name="tampilkan_tembusan" value="1">
                            <input type="hidden" name="tembusan" id="tembusan" value="0">
                            <label class="custom-control-label" for="tampilkan_tembusan">Tembusan</label> <a href="#" data-fancybox data-caption="Akan menampilkan data Tembusan"><i class="fas fa-question-circle text-blue" title="Bantuan" data-toggle="tooltip"></i></a>
                        </div>
                        <div class="custom-control custom-checkbox">
