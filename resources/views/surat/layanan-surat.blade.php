...
@section('title', 'SARASA - Desa '. $desa->nama_desa  .' - Layanan Surat')

@section('styles')
<meta name="description" content="SARASA - Desa {{ $desa->nama_desa }}, Kecamatan {{ $desa->nama_kecamatan }}, Kabupaten {{ $desa->nama_kabupaten }}. Melayani pembuatan surat keterangan secara online">
<style>
    .animate-up:hover {
        top: -5px;
    }
    ...
    <div class="header-body text-center mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6">
                ...
                <p class="">Dengan menggunakan layanan surat, Masyarakat dapat dengan mudah membuat beberapa surat keterangan berikut ini secara online.</p>
