                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div
                            ...
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Reminder</h2>
...
<div class="card bg-secondary shadow h-100">
    <div class="card-body">
        <form autocomplete="off" action="{{ route('reminder.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                <label class="form-control-label col-form-label col-md-3" for="deskripsi">Deskripsi</label>
                <div class="col-md-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <select class="form-control @error('kategori') is-invalid @enderror" name="kategori" id="kategori">
                        ...
                        <option value="1" {{ old('kategori') == 1 ? 'selected="true"' : ''  }}>Reminder</option>
                        <option value="2" {{ old('kategori') == 2 ? 'selected="true"' : ''  }}>Note</option>
                    </select>
                    @error('kategori')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="time" class="form-control" name="waktu"
                        placeholder="Masukkan Waktu..." value="{{ old('waktu') }}">
                    @error('waktu')<span
