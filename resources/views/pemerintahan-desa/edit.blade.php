...
@section('title', 'Edit Aparat Pemerintahan Desa')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Edit Aparat Pemerintahan Desa</h2>
                ...
                <form autocomplete="off" action="{{ route('pemerintahan-desa.update', $pemerintahan_desa) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('nrpd') is-invalid @enderror" name="nrpd" placeholder="Masukkan NRPD ..." value="{{ old('nrpd', $pemerintahan_desa->nrpd) }}">
