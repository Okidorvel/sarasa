            ...
            <div class="col-xl-3 col-md-6 col-sm-6 mb-3">
                <div class="card card-stats shadow h-100">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0">Jumlah Aparat Pemerintahan Desa</h5>
                ...
                <tbody>
                    @forelse ($pemerintahan_desa as $key => $item)
                        <tr>
                            ...
                            <td style="vertical-align: middle">{{ $item->nrpd ?? '-' }}</td>
        ...
        $(document).on('click', '#delete', function(){
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini?")) {
                ...
                if (id.length > 0) {
                    ...
                    alertFail('Harap pilih salah satu aparat Pemerintahan');
                }
            }
        });
