...
class SuratController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('surat.index', compact('surat','pemerintahan_desa','desa', 'kop_surat'));
    }
    ...
    public function layanan_surat()
    {
        ...
        $desa = Desa::find(1);
        $kop_surat = KopSurat::all();
        return view('surat.layanan-surat', compact('surat','desa', 'kop_surat'));
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'kop_surat'=> ['required','string','max:8'],
            'isi.*'     => ['required']
        ],[
