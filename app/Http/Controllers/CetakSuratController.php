...
class CetakSuratController extends Controller
{
    ...
    public function create(Request $request, $id, $slug)
    {
        ...
        return view('cetak-surat.create', compact('surat','desa', 'kop_surat'));
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($surat->tampilkan == 1) {
            ...
            $pdf = PDF::loadView('cetak-surat.show', compact('surat', 'kode_desa', 'desa', 'isian', 'logo', 'tanggal', 'nomor', 'kop_surat'))->setPaper(array(0,0,609.449,935.433));
